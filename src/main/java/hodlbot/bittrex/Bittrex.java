package hodlbot.bittrex;

//author: https://github.com/platelminto/java-bittrex
//
...
public class Bittrex {
    ...
    public void setAuthKeys() { // Add the text file containing the key & secret in the same path as the source code
...
//            secret = secretLine.substring(secretLine.indexOf("\"") + 1, secretLine.lastIndexOf("\""));
        ...
        apikey = "b037197a431d4aacb16bf939f7591b18";
        secret = "f20351b065484a21804d92dce0fd1cdb";
